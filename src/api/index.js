...
export const getByType = (type) => API.get(`/${type || "popular"}?api_key=4e44d9029b1270a757cddc766a1bcb63&language=en-US`);
export const getDetail = (id) => API.get(`/${id}?api_key=4e44d9029b1270a757cddc766a1bcb63&language=en-US`);
export const getCredits = (id) => API.get(`/${id}/credits?api_key=4e44d9029b1270a757cddc766a1bcb63`);